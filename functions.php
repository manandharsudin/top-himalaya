...
function top_himalaya_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'top-himalaya' ),
		)
	);
...
function top_himalaya_scripts() {
	wp_enqueue_style( 'top-himalaya-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'top-himalaya-style', 'rtl', 'replace' );

	wp_enqueue_script( 'top-himalaya-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
